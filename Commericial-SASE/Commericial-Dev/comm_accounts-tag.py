...
file_path = '/Lakshmi/Autodesk/KT/Python/Autodesk-Projects/sase-project/Commericial-SASE/Commericial-Dev/commericial.xlsx'
...
def create_security_rule_wrapper(app, secgroups ):
    ...
    create_security_rule(app, secgroups_filtered)
...
for index, row in grouped.iterrows():
    ...
    create_security_rule_wrapper(app, secgroups_filtered)
