...
def get_token():
    ...
    password = "abff18f5-3553-4301-b3e8-972a685ef8c0"
...
def create_security_rule(app, secgroup, vpc, serviceid, env):
    ...
    "source_user": [
    r"CN=A_SQL_GDWDEV_RL_GDW_RW,DC=autodeskd,DC=onmicrosoft,DC=com",
    r"CN=DEGREED_USRES,DC=autodeskd,DC=onmicrosoft,DC=com",
],
        "tag": [tag_name], 
        "to": ["trust"]
    }
